...
public class FirstPersonView {
    ...
    static final ColorDrawable greenWM = new ColorDrawable(0x115740);
    static final ColorDrawable goldWM = new ColorDrawable(0x916f41);
    static final ColorDrawable yellowWM = new ColorDrawable(0xFFFF99);
...
/*    private Color blend(Color fstColor, Color sndColor, double weightFstColor) {
    ...
    private void drawWall(Wall wall) {
        ...
        /*int color=wall.getColor().toArgb();*/
        /*panel.setARGB(255,83,193,208);*/
        /*panel.setARGB(255,255,231,87);*/
        panel.setARGB(255,72,72,136);
