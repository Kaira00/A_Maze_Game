...
//    private static final Color greenWM = Color.valueOf(115740);
//    private static final int goldWM = Color.parseColor("#916f41");
//    private Context context;
    /*private static final int goldWM = Resources.getSystem().getColor(R.color.goldWM);
    private static final int greenWM = Resources.getSystem().getColor(R.color.greenWM);*/
    private static final int goldWM = Color.LTGRAY;
    ...
    /*    private static final Color CIRCLE_HIGHLIGHT = new Color.valueof(1.0f, 1.0f, 1.0f, 0.8f);*/
    ...
    /*    private static final Color CIRCLE_SHADE = new Color();*/
     ...
     */
    public CompassRose() {
        this(0.9, 1.7, Typeface.SERIF/*Resources.getSystem().getFont(R.font.shojumaru)*/);
    }
...
/*        g2.setRenderingHint(RenderingHints.KEY_RENDERING, RenderingHints.VALUE_RENDER_QUALITY);
    ...
    private void drawBackground(final MazePanel panel) {
        ...
        /*panel.setARGB(250,200,168,64);*/
        /*panel.setARGB(250,243,181,98);*/
...
//        panel.setColor(CIRCLE_HIGHLIGHT);
    ...
    private void drawMarker(MazePanel panel, float x, float y, String str) {
        ...
        panel.setTypeface(markerFont);
        panel.addMarker(x-30,y+30,str);
    }
}
