...
public class Constants {
    ...
    public static final int VIEW_WIDTH = 1430; //default: 400
    public static final int VIEW_HEIGHT = 1430; //default: 400
    public static final int MAP_UNIT = 128; //default: 128
    ...
    //
    public enum State {Title, Generating, PlayAnimation, PlayManually, RobotWin, lost, WinManually}
